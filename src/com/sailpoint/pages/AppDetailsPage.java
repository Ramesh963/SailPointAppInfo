...
public class AppDetailsPage extends BaseTest{
	...
	public AppDetailsPage getDescription() {
		...
		String status=driver.findElementByXPath("//*[@style='font-size: 12px; font-family: \"Open Sans\", \"Helvetica Neue\", Helvetica, Arial, sans-serif; background-image: none; background-repeat: repeat; background-color: rgb(255, 255, 255); color: rgb(51, 51, 51); background-attachment: fixed; cursor: text;']").getText();
